...
class GildedRoseTest {
    ...
    void qualityIsNeverMoreThan50() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES_TO_A_TAFKAL_80_ETC_CONCERT, 10, 50) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void qualityOfSulfurasNeverDecreases() {
        Item[] items = new Item[] { new Item(GildedRose.SULFURAS_HAND_OF_RAGNAROS, 10, 10) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void qualityOfBackstagePassesIncreaseBy2TenDaysBeforeConcert() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES_TO_A_TAFKAL_80_ETC_CONCERT, 6, 10) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void qualityOfBackstagePassesIncreaseBy3ThreeDaysBeforeConcert() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES_TO_A_TAFKAL_80_ETC_CONCERT, 2, 10) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void qualityOfBackstagePassesDropsToZeroAfterTheConcert() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES_TO_A_TAFKAL_80_ETC_CONCERT, 0, 10) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(0, app.items[0].quality);
    }
